...
export class RefreshTokenController {
  ...
  @ApiResponse({
    status: 200,
    description: 'All refresh tokens have been fetched',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'The refresh token has been fetched',
  })
  ...
  @ApiResponse({
    status: 201,
    description: 'The refresh token has been created',
  })
  @ApiResponse({ status: 400, description: 'Wrong data input' })
  @ApiResponse({
    status: 500,
    description: 'Could not create the refresh token',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'The refresh token has been updated',
  })
  @ApiResponse({ status: 400, description: 'Wrong data input' })
  @ApiResponse({
    status: 500,
    description: 'Could not update the refresh token',
  })
  update(
