...
const visionCards = [
  {
    ...
    copy:
      'On présente souvent la pierre comme l’un des meilleurs moyens de construire du patrimoine. Dans les faits, le capital initial, la complexité de gestion et la tension du marché excluent la majorité des profils.',
  },
  {
    icon: '02',
    title: 'La réponse NeoImmo',
    copy:
      'NeoImmo permet d’acheter une fraction de bien immobilier plutôt qu’un actif entier. L’entrée se fait avec un ticket réduit, sans devoir immobiliser le capital d’un achat complet.',
  },
  {
    icon: '03',
    title: 'Ce que la technologie change',
    copy:
      'La blockchain et les smart contracts automatisent la distribution des loyers, la traçabilité des parts et une partie des échanges, tout en laissant une interface compréhensible pour des profils non crypto.',
  },
];
...
const audienceCards = [
  {
    ...
    copy:
      'Des investisseurs retail qui veulent accéder à l’immobilier sans attendre d’avoir un apport massif dès le départ.',
  },
  {
    icon: 'B',
    title: 'Jeunes actifs, étudiants et primo-investisseurs',
    copy:
      'Des profils avec une épargne limitée, à la recherche d’une première exposition à un actif réel plus stable qu’un produit purement spéculatif.',
  },
  {
    icon: 'C',
    title: 'Profils orientés revenus passifs',
    copy:
      'Des utilisateurs qui cherchent une source de revenus récurrents, avec moins de friction de gestion qu’une détention immobilière traditionnelle.',
  },
];
...
const modelCards = [
  {
    ...
    copy:
      'La plateforme découpe l’investissement de manière plus granulaire que les modèles classiques de propriété partagée, afin de réduire le montant à engager par utilisateur.',
  },
  {
    icon: '02',
    title: 'Monétisation simple et récurrente',
    copy:
      'Le modèle combine des frais de transaction sur les ventes tokenisées et des frais de gestion récurrents liés à l’exploitation des actifs et aux loyers.',
  },
  {
    icon: '03',
    title: 'Gouvernance organisée, pas de blocage',
    copy:
      'Les décisions importantes comme une vente ou des travaux peuvent être structurées via des votes majoritaires, au lieu de laisser des copropriétaires coincés dans un “mariage” financier ingérable.',
  },
  {
    icon: '04',
    title: 'Exécution scalable',
    copy:
      'Le business plan vise un break-even au mois 9, avec une montée progressive des actifs sous gestion, un objectif de revenus année 1 à 1,2 M$ et un besoin d’amorçage estimé entre 500 k$ et 1,5 M$ pour lancer proprement le MVP.',
  },
];
...
export default function LandingPage({ onAuthenticated }: LandingPageProps) {
  ...
  const totalTokens = properties.reduce((sum, property) => sum + property.tokenNumber, 0);
  const leadNoticeClassName =
    leadNotice?.tone === 'success' ? styles.noticeSuccess : styles.noticeError;
  const signupNoticeClassName =
    signupNotice?.tone === 'success' ? styles.noticeSuccess : styles.noticeError;
      ...
      <div className={styles.shell}>
        <header className={styles.header}>
          ...
          <div className={styles.headerActions}>
            ...
            <a href="#signup" className={styles.primaryAction}>S'inscrire
            </a>
          </div>
        </header>
        ...
        <section className={styles.hero}>
          <div className={styles.mainTitle}>
            <div className={styles.eyebrow}>Immobilier fractionné & blockchain</div>
            <h1 className={styles.heroTitle}>
              Posséder une partie d&apos;un immeuble depuis son téléphone.
            </h1>
            <p className={styles.heroSubtitle}>
              NeoImmo ouvre l’investissement immobilier à des profils qui en sont
              habituellement exclus par le capital initial. Vous achetez une fraction
              de bien, vous suivez vos parts dans une interface simple, et le projet
              prépare l’automatisation des flux locatifs et de la gouvernance.
            </p>
            ...
            <div className={styles.heroMetrics}>
              <article className={styles.metric}>
                ...
                <p>Une première vitrine pour découvrir les biens déjà publiés sur la plateforme.</p>
              </article>
              <article className={styles.metric}>
                <span>Tokens exposés</span>
                <strong>{loading ? '...' : new Intl.NumberFormat('fr-FR').format(totalTokens)}</strong>
                <p>Le volume affiché permet de donner immédiatement l’échelle du marché visé.</p>
              </article>
              <article className={styles.metric}>
                <span>Break-even ciblé</span>
                <strong>Mois 9</strong>
                <p>Un objectif de montée en charge posé dans le business plan, après onboarding des premiers actifs.</p>
              </article>
            </div>
          </div>
        </section>
        ...
        <section id="vision" className={styles.section}>
          <div className={styles.sectionHeader}>
            <div>
              ...
              <h2>Rendre la pierre accessible sans trahir la logique d’un actif réel</h2>
              <p>
                L’idée n’est pas de rendre l’immobilier “plus hype”. L’idée est de
                débloquer un marché historiquement fermé, en combinant fractionnement
                de l’investissement, transparence et automatisation.
              </p>
            </div>
          </div>
        ...
        <section id="market" className={styles.section}>
          <div className={styles.sectionHeader}>
            <div>
              ...
              <p>
                Nous proposons un large eventails de biens disponible pour l'achat fractionné
              </p>
            </div>
                ...
                <article key={property.id} className={styles.carouselCard}>
                  ...
                  <div className={styles.carouselCopy}>
                    ...
                    <div className={styles.carouselFooter}>
                      ...
                      <small>{new Intl.NumberFormat('fr-FR').format(property.tokenNumber)} tokens</small>
                    </div>
                  </div>
                </article>
              ))}
        ...
        <section id="audience" className={styles.section}>
          <div className={styles.sectionHeader}>
            <div>
              ...
              <p>
                Le projet vise d’abord des utilisateurs qui veulent une exposition immobilière
                lisible, plus flexible et moins lourde qu’un achat direct.
              </p>
            </div>
          </div>
        ...
        <section id="model" className={styles.section}>
          <div className={styles.sectionHeader}>
            <div>
              ...
              <h2>Un produit pensé pour être simple côté utilisateur et robuste côté plateforme</h2>
              <p>
                NeoImmo ne se limite pas à tokeniser des biens. Le projet articule
                accessibilité, gouvernance, frais compréhensibles et montée en charge progressive.
              </p>
            </div>
          </div>
        ...
        <section id="roadmap" className={styles.section}>
          <div className={styles.sectionHeader}>
            <div>
              ...
              <p>
                La logique est simple: valider, onboarder les premiers actifs, automatiser
                les flux, puis élargir le catalogue dans un cadre de conformité solide.
              </p>
            </div>
          </div>
        ...
        <section id="contact" className={styles.section}>
          <div className={styles.sectionHeader}>
            <div>
              ...
              <h2>Premiers utilisateurs, partenaires actifs et retours concrets</h2>
              <p>
                Aujourd’hui, l’enjeu est de confronter NeoImmo au terrain: comprendre les
                attentes des premiers utilisateurs, structurer des partenariats et préparer
                l’exécution à plus grande échelle.
              </p>
            </div>
          </div>
            ...
            <article className={styles.contactPanel}>
              <div className={styles.contactStack}>
                <div>
                  ...
                  <p>
                    Que vous soyez investisseur, opérateur immobilier, partenaire ou simplement
                    intéressé par le concept, laissez-nous votre contexte pour que l’on vous
                    recontacte dans le bon cadre.
                  </p>
                </div>
                ...
                <div className={styles.contactMini}>
                  ...
                  <p>Nous cherchons des retours concrets pour ajuster l’expérience avant montée en charge.</p>
                </div>
                <div className={styles.contactMini}>
                  <span>Partenariats</span>
                  <strong>Opérateurs immobiliers, property managers, communautés financières</strong>
                  <p>Le projet a besoin d’actifs, de distribution et de relais de confiance.</p>
                </div>
                <div className={styles.contactMini}>
                  <span>Canaux</span>
                  <strong>Whitelist, newsletter, Instagram, LinkedIn</strong>
                  <p>Le lancement passe d’abord par une communauté engagée et bien informée.</p>
                </div>
                ...
                <form className={styles.contactForm} onSubmit={handleLeadSubmit}>
                  ...
                  <p className={styles.formNote}>
                    Chaque message nous aide à prioriser le produit, les partenariats et la préparation du lancement.
                  </p>
                </form>
              </div>
            </article>
            ...
            <div className={styles.signupStack}>
              <article id="signup" className={styles.signupPanel}>
                <div>
                  ...
                  <h3>Créer un compte et rejoindre la première cohorte NeoImmo</h3>
                  <p>
                    L’inscription vous donne un accès immédiat à l’espace NeoImmo et prépare
                    les futurs parcours de qualification investisseur, de KYC et de suivi de portefeuille.
                  </p>
                </div>
                ...
                <form className={styles.signupForm} onSubmit={handleSignupSubmit}>
                  ...
                  >
                    {signupSubmitting ? 'Création du compte...' : 'Rejoindre NeoImmo'}
                  </button>
                </form>
              </article>
              ...
              <article className={styles.faqPanel}>
                <div>
                  <div className={styles.eyebrow}>Connexion & compréhension</div>
                  <h3>Déjà onboardé ou simplement en veille ?</h3>
                  <p>
                    Connectez-vous si vous avez déjà un compte. Sinon, poursuivez avec la FAQ
                    pour comprendre le produit, son stade d’avancement et sa logique économique.
                  </p>
                </div>
        ...
        <section id="faq" className={styles.section}>
          <div className={styles.sectionHeader}>
            <div>
              ...
              <p>
                Ces réponses posent le cadre: accessibilité, rôle de la blockchain, gestion des revenus et gouvernance des actifs.
              </p>
            </div>
          </div>
        ...
        <footer className={styles.footer}>
          <span>NeoImmo ouvre l’investissement immobilier à une nouvelle génération d’utilisateurs, avec plus de fluidité, plus de transparence et moins de barrières à l’entrée.</span>
